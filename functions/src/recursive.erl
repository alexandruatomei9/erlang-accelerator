-module(recursive).
-export([fac/1, len/1, tail_fac/1, tail_len/1, duplicate/2, tail_duplicate/2, tail_reverse/1, tail_sublist/2, zip/2, lenient_zip/2, tail_zip/2, lenient_tail_zip/2, quicksort/1]).
